...
const projects = [
  ...
  },
  {
    ...
    description:
      "A machine learning system that analyzes financial transactions to identify and flag potentially fraudulent activities in real-time, enhancing security for users and financial institutions.",
    image:
